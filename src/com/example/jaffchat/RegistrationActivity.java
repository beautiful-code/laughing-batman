...
//			}
			...
			try {
				...
				case 201: HttpEntity entity = httpResponse.getEntity();
...
//					break;
		...
		protected void onPostExecute(String result) {
			...
			Intent intent = new Intent(RegistrationActivity.this, JaffaMainActivity.class); 
