...
public class GetMessages extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		HttpGet httpGet = new HttpGet(UserData.HOST+"/rooms/"+roomId+".json?"+"auth_token="+authentication_token); 
		...
		try {
			...
			case 200:
				...
				Intent intent1 = new Intent("com.example.locationbased.action.initializeui");
